package dev.android.khurkham.customfontpanglong.fonttailibrary.utils;
...
import dev.android.khurkham.customfontpanglong.fonttailibrary.R;
...
public class CustomFontUtils {
    ...
    public static Typeface getTypeFace(final TextView v,
        ...
        String fontName = "";
        try {
            fontName = tArray.getString(R.styleable.customFont_fonttai);
        } finally {
            tArray.recycle();
        }
